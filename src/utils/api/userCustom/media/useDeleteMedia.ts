/**
 * @file useDeleteMedia.ts
 * @description 사용자 추가 미디어 삭제하기
 */
 ...
 */
export const apiDeleteMedia = async (id: number): Promise<BaseResponseCommonObject> => {
...
export const useDeleteMedia = (
  ...
  return useMutation(apiDeleteMedia, options)
}
