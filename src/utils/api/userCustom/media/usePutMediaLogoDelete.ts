/**
 * @file usePutMediaLogoDelete.ts
 * @description 사용자 추가 미디어 로고 삭제
 */
...
}${apiVersion}/svc/media/logo/delete`
 ...
 */
export const apiPutMediaLogoDelete = async (id: Number): Promise<BaseResponseCommonObject> => {
 ...
 */
export const usePutMediaLogoDelete = (
  ...
  return useMutation(apiPutMediaLogoDelete, options)
}
