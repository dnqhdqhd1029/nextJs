/**
 * @file useDeleteCustomNews.ts
 * @description 사용자 추가 뉴스 삭제하기
 */
 ...
 */
export const apiDeleteCustomNews = async (id: number): Promise<BaseResponseCommonObject> => {
 ...
 */
export const useDeleteCustomNews = (
  ...
  return useMutation(apiDeleteCustomNews, options)
}
