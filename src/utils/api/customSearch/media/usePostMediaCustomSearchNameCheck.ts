/**
 * @file usePostMediaCustomSearchNameCheck.ts
 * @description 미디어 맞춤 검색 Title 중복 확인
 */
...
}${apiVersion}/svc/mediasrch/checkname`
 ...
 */
export const apiPostMediaCustomSearchNameCheck = async (
 ...
 */
export const usePostMediaCustomSearchNameCheck = (
  ...
  return useMutation(apiPostMediaCustomSearchNameCheck, options)
}
