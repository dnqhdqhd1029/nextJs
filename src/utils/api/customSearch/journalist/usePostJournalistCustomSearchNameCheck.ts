/**
 * @file usePostJournalistCustomSearchNameCheck.ts
 * @description 언론인 맞춤 검색 Title 중복 확인
 */
...
}${apiVersion}/svc/journalistsrch/checkname`
 ...
 */
export const apiPostJournalistCustomSearchNameCheck = async (
 ...
 */
export const usePostJournalistCustomSearchNameCheck = (
  ...
  return useMutation(apiPostJournalistCustomSearchNameCheck, options)
}
