 ...
 */
export const apiDeleteNewswireRelease = async ({
  id,
  group,
}: UseDeleteActionParams): Promise<BaseResponseCommonObject> => {
 ...
 * @returns {Promise<BaseResponseCommonObject>}
 */
export const apiLockNewswireRelease = async ({
  id,
  group,
}: UseDeleteActionParams): Promise<BaseResponseCommonObject> => {
  const accessToken = Cookie.get(ACCESS_TOKEN_NAME) ?? ''
 ...
 * @returns {Promise<BaseResponseCommonObject>}
 */
export const apiUnLockNewswireRelease = async ({
  id,
  group,
}: UseDeleteActionParams): Promise<BaseResponseCommonObject> => {
  const accessToken = Cookie.get(ACCESS_TOKEN_NAME) ?? ''
...
export const useDeleteRelease = (
  ...
  return useMutation(apiDeleteNewswireRelease, options)
}
export const useLockRelease = (
  options?: UseMutationOptions<BaseResponseCommonObject, AxiosError, UseDeleteActionParams>
): UseMutationResult<BaseResponseCommonObject, AxiosError, UseDeleteActionParams> => {
  return useMutation(apiLockNewswireRelease, options)
}
export const useUnLockRelease = (
  options?: UseMutationOptions<BaseResponseCommonObject, AxiosError, UseDeleteActionParams>
): UseMutationResult<BaseResponseCommonObject, AxiosError, UseDeleteActionParams> => {
  return useMutation(apiUnLockNewswireRelease, options)
}
