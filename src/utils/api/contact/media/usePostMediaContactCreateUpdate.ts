/**
 * @file usePostMediaContactCreateUpdate.ts
 * @description 미디어 개인적 연락처 추가/수정
 */
 ...
 */
export const apiPostMediaContactCreateUpdate = async (
 ...
 */
export const usePostMediaContactCreateUpdate = (
  ...
  return useMutation(apiPostMediaContactCreateUpdate, options)
}
