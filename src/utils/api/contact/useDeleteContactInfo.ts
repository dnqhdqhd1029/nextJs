/**
 * @file useDeleteContactInfo.ts
 * @description 개인적 연락처 삭제
 */
 ...
 */
export const apiDeleteContactInfo = async (id: number): Promise<BaseResponseCommonObject> => {
...
export const useDeleteContactInfo = (
  ...
  return useMutation(apiDeleteContactInfo, options)
}
