/**
 * @file usePostTaggingReset.ts
 * @description 태깅 다시 적용. category: NEWS / ACTION
 */
 ...
 */
export const apiPostTaggingReset = async (requestTaggingDto: RequestTaggingDto): Promise<BaseResponseCommonObject> => {
 ...
 */
export const usePostTaggingReset = (
  ...
  return useMutation(apiPostTaggingReset, options)
}
