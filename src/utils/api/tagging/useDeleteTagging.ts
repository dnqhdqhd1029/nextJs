/**
 * @file useDeleteTagging.ts
 * @description 1개의 news 혹은 action에서 태깅을 삭제
 */
 ...
 */
export const apiDeleteTagging = async (id: number): Promise<BaseResponseCommonObject> => {
...
export const useDeleteTagging = (
  ...
  return useMutation(apiDeleteTagging, options)
}
