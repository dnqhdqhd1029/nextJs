 ...
 */
export const apiDeleteMonitoring = async (id: number): Promise<BaseResponseCommonObject> => {
...
export const useDeleteMonitoring = (
  ...
  return useMutation(apiDeleteMonitoring, options)
}
