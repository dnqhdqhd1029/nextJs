/**
 * @file useDeleteActionComment.ts
 * @description 그룹 삭제
 */
 ...
 */
export const apiDeleteActionComment = async (id: number): Promise<BaseResponseCommonObject> => {
 ...
 */
export const useDeleteActionComment = (
  ...
  return useMutation(apiDeleteActionComment, options)
}
