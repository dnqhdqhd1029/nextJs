/**
 * @file apiGetJournalistImage.ts
 * @description 언론인 이미지 정보 조회
 */
...
}${apiVersion}/svc/image/journalist`

/**
 * Axios API
 * @param {number} id - 언론인 이미지 ID
 * @returns
 */
export const apiGetJournalistImage = async (id: number) => {
