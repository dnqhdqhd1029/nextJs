          ...
          <nav className="header-gnb__menu">
            <ul className="header-gnb__menu-list">
              ...
              <li className="is-active">
                <div className="select__section select-type3-n1">
                  <button className="select__label">
                    <span className="select__label-text">미디어</span>
                    <IcoSvg data={icoSvgData.chevronDown} />
                  </button>
                      ...
                      <ul className="select-option__group">
                        ...
                        <li>
                          <button className="select-option__item is-selected">
                            <span className="select-option__item-text">미디어 리스트</span>
                          </button>
                        </li>
                        <li>
                          <button className="select-option__item">
                            <span className="select-option__item-text">연락처 추가</span>
                          </button>
                        </li>
                        <li>
                          <button className="select-option__item">
                  ...
                  <div className="select-option__section">
                    <div className="select-option__area">
                      <ul className="select-option__group">
                        <li>
                          <button className="select-option__item">
                            <span className="select-option__item-text">뉴스 검색</span>
                          </button>
                        </li>
                        <li>
                          <button className="select-option__item">
                            <span className="select-option__item-text">뉴스 맞춤 검색</span>
                          </button>
                        </li>
                        <li>
                          <button className="select-option__item">
                            <span className="select-option__item-text">클립북</span>
                          </button>
                        </li>
                        <li>
                          <button className="select-option__item">
                            <span className="select-option__item-text">뉴스 추가</span>
                          </button>
                        </li>
                        <li>
                          <button className="select-option__item">
                        ...
                        <li>
                          <button className="select-option__item">
                            <span className="select-option__item-text">뉴스 태그</span>
                          </button>
                        </li>
                      </ul>
                    </div>
              ...
              <li>
                <div className="select__section select-type3-n1">
                  <button className="select__label">
                    <span className="select__label-text">배포하기</span>
                    <IcoSvg data={icoSvgData.chevronDown} />
                  </button>
              ...
              <li className="is-active">
                <div className="select__section select-type3-n2">
                  <button className="select__label">
                    <span className="select__label-text">캠페인</span>
                    <IcoSvg data={icoSvgData.chevronDown} />
                  </button>
                  ...
                  <div className="select-option__section">
                    <div className="select-option__area">
                      <p className="select-option__notice-text">
                        현재 사용 중인 상품은 캠페인 기능이 없어 업그레이드가 필요합니다.
                      </p>
                      <Button
                        label={'업그레이드'}
                        cate={'default'}
