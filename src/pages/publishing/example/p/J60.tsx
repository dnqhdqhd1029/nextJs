            ...
            <div className="mb-contents-header__section type-sticky">
              <div className="common-title__section">
                <div className="common-title__group">
                  <h2 className="common-title__title">엑셀로 언론인 추가</h2>
                  ...
                  <ul className="bullet-list">
                    <li>
                      <p className="bullet-list__text">
                        언론인을 위 샘플을 참고해 엑셀 또는 CSV파일로 저장한 후 업로드하세요.
                      </p>
                    </li>
                    <li>
                      <p className="bullet-list__text">이름, 매체, 이메일은 필수 입력 필드입니다.</p>
                    </li>
                    <li>
                      <p className="bullet-list__text">
