                                  ...
                                  <ul className="interval-mt8">
                                    ...
                                    <li>
                                      <div className="list-type8-item__desc">
                                        <b className="print">삼성</b>전자는 지난해 9월 발표한 신 환경경영전략을 바탕으로
                                        소재부터 생산·포장·사용·폐기까지 제품 생애주기(Product Life Cycle)별 친환경
                                        노력을 전시장 전면에 소개하며, 지속 가능한 미래를 위한 비전을 다시 한번
                                        강조한다. <b className="print">삼성</b>
                                        전자의 친환경 상업용 디스플레이 제품을 사용함으로써 고객들이 기후 변화 대응과
                                        자원 순환 제고에 동참할 수 있도록 했다. 이를 위해 △2023년형 스마트 사이니지 Q
                                        시리즈 △원격관리(Remote Management) 기능을 강화한 ‘매직인포(MagicINFO)' 솔루션을
                                        소개한다.
                                      </div>
                                    </li>
                                  </ul>
                                  ...
                                  <ul className="interval-mt8">
                                    ...
                                    <li>
                                      <div className="list-type8-item__desc">
                                        ...
                                        생산·포장·사용·폐기까지 제품 생애주기(Product Life Cycle)별 친환경 노력을 전시장
                                        전면에 소개하며, 지속 가능한 미래를 위한 비전을 다시 한번 강조한다. 삼성전자의
                                        친환경 상업용 디스플레이 제품을 사용함으로써 고객들이 기후 변화 대응과 자원 순환
                                        제고에 동참할 수 있도록 했다. 이를 위해 △2023년형 스마트 사이니지 Q 시리즈
                                        △원격관리(Remote Management) 기능을 강화한 ‘매직인포(MagicINFO)' 솔루션을
                                        소개한다. 삼성전자는 지난해 9월 발표한 신 환경경영전략을 바탕으로 소재부터
                                        생산·포장·사용·폐기까지 제품 생애주기(Product Life Cycle)별 친환경 노력을 전시장
                                        전면에 소개하며, 지속 가능한 미래를 위한 비전을 다시 한번 강조한다. 삼성전자의
                                        친환경 상업용 디스플레이 제품을 사용함으로써 고객들이 기후 변화 대응과 자원 순환
                                        제고에 동참할 수 있도록 했다. 이를 위해 △2023년형 스마트 사이니지 Q 시리즈
                                ...
                                <li className="list-type8-item__contents">
                                  <ul className="interval-mt8">
                                    <li>
                                      <div className="list-type8-item__header">
                                        {/* <div className="list-type8-item-header__ico">
                                          <IcoSvg data={icoSvgData.addNews} />
                                        </div> */}
                                        <div className="list-type8-item-header__ico">
                                          <Tooltips
                                            tooltipId={'tt10-1'}
                ...
                <div className="notification-alert__contents">
                  ...
                  <p>
                    <Button
                      elem="a"
                      url={'#!'}
                      label={'삼성전자, 업계 최초 HKMG 공정 적용 고용량 DDR5 메모리 개발'}
                      cate={'link-text'}
                      size={'m'}
                      color={'body-link'}
                    />{' '}
