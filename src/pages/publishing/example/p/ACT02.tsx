                          ...
                          <div className="tabs-panel__section">
                            <div className="tabs-panel__group">
                              <dl className="dl-table-type1__section wide-gap">
                                ...
                                <dd>
                                  <p className="dl-table-type1__text">
                                    신제품 기획기사 관련해 본사에서 회의를 추진합니다.
                                    <br />
                                    중앙일보에서 서정민 / 김민석 / 최서원 기자가 참석하고, 당사에서 마케팅팀 강지영
                                    차장, 상품기획팀 최지혁 팀장 / 임수민 과장 / 차예린 대리가 참석합니다.
                                    <br />
                                    시간: 2022년 3월 26일 오후2시
                                    <br />
                                    장소: 본사 9층 대회의실
                                  </p>
                                </dd>
