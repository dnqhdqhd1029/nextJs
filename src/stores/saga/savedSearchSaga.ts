...
import { mediaCategoryChangedAction } from '~/stores/modules/contents/pressMedia/mediaSearchManagement'
import { pressCategoryChangedAction } from '~/stores/modules/contents/pressMedia/pressSearchManagement'
import {
  categoryDataAction,
...
export default function* savedSearchSaga() {
