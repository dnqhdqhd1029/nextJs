...
import { useUserCertification } from '~/utils/hooks/contents/member/useUserCertification'

const UserCertification = () => {
  const { isLoading, endTimeRef, certificationOtp, minute, second, blockedEmail, setOtpNm, getOtpTime, otpAction } =
            ...
            <div className="log-type1-code__group">
              ...
              <div className="log-type1-code__button">
                <Button
                  ...
                  size={'m'}
                  color={'body-link'}
                  onClick={() => getOtpTime(blockedEmail)}
                />
              </div>
            </div>
          </li>
