          ...
          <ul className="grid-col2">
            <li>
              <FormInputText
                title={'이름'}
                required={true}
                onChange={e => setApplicantNameAction(e.target.value, requestPopupTypes)}
            ...
            <li>
              <FormInputText
                title={'이메일'}
                required={true}
                onChange={e => setApplicantEmailAction(e.target.value, requestPopupTypes)}
            ...
            <li>
              ...
              <FormInputText
                ...
                onChangeExtra={e => setApplicantTelePhoneAction(e, requestPopupTypes)}
            ...
            <li>
              <FormInputText
                ...
                onChangeExtra={e => setPhoneCallNmAction(e, requestPopupTypes)}
...
export default RequestPopupNonUser
