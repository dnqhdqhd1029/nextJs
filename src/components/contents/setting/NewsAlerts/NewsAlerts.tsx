...
import NewsAlertsContent from '~/components/contents/setting/NewsAlerts/Content/NewsAlertsContent'
import { defaultSortOptionsByData } from '~/components/contents/setting/NewsAlerts/defaultData'
import NewsAlertsDeletePopup from '~/components/contents/setting/NewsAlerts/Popup/UserProfilePopup/NewsAlertsDeletePopup'
import UserProfilePopup from '~/components/contents/setting/NewsAlerts/Popup/UserProfilePopup/UserProfilePopup'
