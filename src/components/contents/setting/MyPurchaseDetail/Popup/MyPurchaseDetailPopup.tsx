...
const MyPurchaseDetailPopup = () => {
  const { licenseInfo, isMyLicensePopupOpen, setIsMyLicensePopupOpen } = useMyPurchase()

  return (
    <Popup
      isOpen={isMyLicensePopupOpen}
      title={`사용권 정보`}
      onClose={() => setIsMyLicensePopupOpen(false)}
      width={'40vw'}
      maxWidth={'1140px'}
      height={'50vh'}
      hasCloseButton
...
export default MyPurchaseDetailPopup
