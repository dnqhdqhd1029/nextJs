...
const UserProfilePopup = () => {
  const { setUserProfilePopupAction, userPopup } = useMyLicense()
  return (
    <Popup
      isOpen={userPopup.isOpen && userPopup.type === 'userProfile'}
      title={'회원 정보'}
    ...
    >
      <dl className="dl-table-type1__section">
        ...
        <dd>
          <p className="dl-table-type1__text">{userPopup.nickName}</p>
        </dd>
        <dt>
