...
import MediaList from '~/components/contents/distribution/common/Popup/MediaList'
...
const MediaPopupImgContent = (props: Props) => {
  const {
    mediaPopup,
    mediaUploadFile,
        ...
        >
          <section className={cn('fui-dropzone-root', { 'is-disabled': isDragging })}>
            <div className="files-ui-dropzone-children-container">
              <label htmlFor="fileUpload_mediaPopup_img"> 클릭하거나 드래그해 파일을 올리세요.</label>
              <input
                id={'fileUpload_mediaPopup_img'}
                type="file"
...
export default MediaPopupImgContent
