...
import { DefaultChartData, DefaultLineChartData } from '~/components/contents/monitoring/Clipbook/Result/defaultData'
...
import { monitoringAnalysisPopupAction } from '~/stores/modules/contents/monitoring/clipbookDetail'
...
const ClipbookAnalysisPopup = () => {
  ...
  const monitoringGraph = async () => {
    const res = await monitoringDataToChart(monitoringAnalysisPopup, monitoringListParams, pageCount.totalCount)
  ...
  return (
    <>
      <Popup
        ...
        title={`${monitoringAnalysisPopup.title} 클립북 분석`}
...
export default ClipbookAnalysisPopup
