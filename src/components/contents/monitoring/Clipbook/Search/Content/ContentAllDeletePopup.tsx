...
const ContentAllDeletePopup = () => {
  const { clipbookListParams, contentAllDeletePopup, initSelectedAllDeleteContent, selectedAllDeleteAction } =
    useMonitoringClipbookSearch()
  const [isLoading, setIsLoading] = useState(false)

  const deleteAction = async () => {
    setIsLoading(() => true)
    await selectedAllDeleteAction(contentAllDeletePopup, clipbookListParams)
    setIsLoading(() => false)
  }
...
export default ContentAllDeletePopup
