...
const ContentDeletePopup = () => {
  const { clipbookListParams, contentDeletePopup, setSelectedDeleteContent, selectedDeleteAction } =
    useMonitoringClipbookSearch()
  const [isLoading, setIsLoading] = useState(false)

  const deleteAction = async () => {
    setIsLoading(() => true)
    await selectedDeleteAction(contentDeletePopup, clipbookListParams)
    setIsLoading(() => false)
  }
  return (
    <>
