      ...
      <div className={cn('list-type8-item__section', { 'is-selected': props.newsid === newsIdKey })}>
        <ul className="list-type8-item__list">
          ...
          >
            <FormInputBtn
              type="checkbox"
              name={'monitoring-result__header-sort newsList' + props.newsid?.toString() || ''}
              id={'monitoring-result__header-sort newsList' + props.newsid?.toString() || ''}
              checked={isChecked}
              label=""
