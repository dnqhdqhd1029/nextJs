...
import MonitoringReportGroupingItem from '~/components/contents/monitoring/MonitoringList/Popup/MonitoringReportGroupingItem'
import { useMonitoringSearch } from '~/utils/hooks/contents/monitoring/useMonitoringSearch'

const MonitoringReportNewsItem = () => {
  const { reportPopup, setMonitoringReportPopupIsDragging, setMonitoringReportPopupDragOver } = useMonitoringSearch()
