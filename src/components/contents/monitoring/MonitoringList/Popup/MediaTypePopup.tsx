...
import MediaTypeItem from '~/components/contents/monitoring/MonitoringList/Popup/MediaTypeItem'
...
const MediaTypePopup = () => {
  ...
  const actionButton = async () => {
    setIsLoading(() => true)
    await mediaTypePopupAdjust(mediaTypePopup.selectedType, monitoringSearchOptionParams)
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setMediaTypePopupAction([], false, monitoringSearchOptionParams)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setMediaTypePopupAction([], false, monitoringSearchOptionParams)}
            />
          </div>
        }
      >
