...
import ContentItem from '~/components/contents/monitoring/MonitoringList/LeftContent/ContentItem'
...
const Content = (props: monitoringListDto) => {
  ...
  return (
    <div
      ...
      id={'monitoringList__accordion_category' + props.categoryNm}
    >
              ...
              {props.content && props.content.length > 0 && (
                <Fragment>
                  {props.content.slice(0, 10 * isExpand).map(e => (
                    <ContentItem
                      key={'monitoringList__accordion_category_accordion-type1' + e.newsSrchId}
                      {...e}
                    />
                  ))}
