...
import SearchFilterItemSub from '~/components/contents/monitoring/SearchResult/LeftContent/SearchFilterItemSub'
...
const SearchFilterItem = (props: NavigationLinkItem) => {
  ...
  const [taskList, setTaskList] = useState<NavigationLinkItem[]>(props.subMenus ?? [])
                ...
                <Button
                  ...
                  disabled={
                    !!(
                      ...
                      filterSubParamActions[indexNm].values.length >= taskList.length
                    )
                  }
                  onClick={() =>
                    props.subMenus &&
