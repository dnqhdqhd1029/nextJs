...
import MonitoringReportGroupingItem from '~/components/contents/monitoring/SearchResult/Popup/MonitoringReportGroupingItem'
...
const MonitoringReportNewsItem = () => {
  const { reportPopup, setMonitoringReportPopupIsDragging, setMonitoringReportPopupDragOver } =
