...
const News = () => {
  ...
  const { countLoading } = useAppSelector(state => state.newsSearchResultSlice)
        ...
        <ul className="interval-mt28">
            ...
            <dl className="dl-table-type1__section">
              {newsIdParams.isSysInfo && (
                <Fragment>
                  ...
                  <dd>
                    <p className="dl-table-type1__text type-link">{toneValue !== '' ? toneValue : '알수없음'}</p>
                  </dd>
                </Fragment>
              )}
              {/*<dt>*/}
          ...
          {newsIdParams && newsIdParams.taggingList && newsIdParams.taggingList.length > 0 && (
            <li>
              ...
              {/*{newsIdParams.taggingList.map(e => (*/}
              {/*  <Tag*/}
              {/*    key={'newsIdParams.taggingList' + e.taggingId + e.tagId}*/}
              {/*    label={e.tagName}*/}
              {/*    cate={'n3'}*/}
