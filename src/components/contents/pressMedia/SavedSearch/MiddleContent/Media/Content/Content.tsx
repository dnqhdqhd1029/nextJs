...
import ContentItem from '~/components/contents/pressMedia/SavedSearch/MiddleContent/Media/Content/ContentItem'
...
const MediaContent = () => {
  ...
  const searchReset = () => {
    ...
    mediaKeywordSearch('', mediaDto, mediaListParams, savedMediaKey, isOwner, isFilterSubParam)
  }
      ...
      {mediaParamKeywordButton && (
        <div className="search-result__search">
          <FormInputSearch
            ...
            onKeyDown={e =>
              e.key === 'Enter' &&
              mediaKeywordSearch(mediaParamKeyword, mediaDto, mediaListParams, savedMediaKey, isOwner, isFilterSubParam)
            }
