...
const MediaSavedSearchEditPopup = () => {
  ...
  const setAction = async () => {
    setIsLoading(() => true)
    const check = await checkUpdateMediaSavedSearchValidation(savedSearchPopup)
    if (check) {
      await updateMediaSavedSearch(savedSearchPopup)
    }
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        isOpen={savedSearchPopup.isOpen && savedSearchPopup.type === 'media'}
