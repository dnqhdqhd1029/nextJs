...
const PressSavedSearchEditPopup = () => {
  ...
  const setAction = async () => {
    setIsLoading(() => true)
    const check = await checkUpdatePressSavedSearchValidation(savedSearchPopup)
    if (check) {
      await updatePressSavedSearch(savedSearchPopup)
    }
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        isOpen={savedSearchPopup.isOpen && savedSearchPopup.type === 'press'}
