...
import BasicLocationItem from '~/components/contents/pressMedia/SavedSearch/Popup/BasicLocationItem'
...
const BasicLocationPopup = () => {
  ...
  const actionButton = async () => {
    setIsLoading(() => true)
    await setPressAreaAction(basicLocationPopup.selectedType, pressSearchOptionParams.keywordParam)
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setBasicLocationPopupAction([], false, pressSearchOptionParams)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setBasicLocationPopupAction([], false, pressSearchOptionParams)}
            />
          </div>
        }
      >
