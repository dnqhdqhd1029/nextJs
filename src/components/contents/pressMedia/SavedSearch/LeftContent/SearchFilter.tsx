...
import MediaSearchFilterItem from '~/components/contents/pressMedia/SavedSearch/LeftContent/Media/MediaSearchFilterItem'
import MediaSearchFilterItemSubMenu from '~/components/contents/pressMedia/SavedSearch/LeftContent/Media/MediaSearchFilterItemSubMenu'
import MediaSearchFilterSelectItem from '~/components/contents/pressMedia/SavedSearch/LeftContent/Media/MediaSearchFilterSelectItem'
import PressSearchFilterItem from '~/components/contents/pressMedia/SavedSearch/LeftContent/Press/PressSearchFilterItem'
import PressSearchFilterItemSubMenu from '~/components/contents/pressMedia/SavedSearch/LeftContent/Press/PressSearchFilterItemSubMenu'
import PressSearchFilterSelectItem from '~/components/contents/pressMedia/SavedSearch/LeftContent/Press/PressSearchFilterSelectItem'
      ...
      <div className={cn('lnb-filter__header', { 'top-0': isFilterSubParam })}>
        ...
        <div className="lnb-filter__header-buttons">
          ...
          <Button
            ...
            onClick={() =>
              listDefine === 'press'
                ? setIsClosePressFilterSubParamAction(savedJournalKey, pressDto, pressListParams, isOwner)
                : setIsCloseMediaFilterSubParamAction(savedMediaKey, mediaDto, mediaListParams, isOwner)
            }
          />
        </div>
      </div>
