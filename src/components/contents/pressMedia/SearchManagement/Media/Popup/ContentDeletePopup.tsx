...
const MediaContentDeletePopup = () => {
  const { contentDeletePopup, setSelectedDeleteContent, selectedDeleteAction } = useMediaSavedSearchManagement()
...
export default MediaContentDeletePopup
