...
const MediaOwnerChangePopup = () => {
  const { ownerPopup, ownerChangeAction, setOwnerPopupAction } = useMediaSavedSearchManagement()
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setOwnerPopupAction({ isOpen: false, key: 0, name: '', mediaId: 0 })}
        hasCloseButton
        title={'소유자 변경 확인'}
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              size={'m'}
              color={'link-dark'}
              onClick={() => setOwnerPopupAction({ isOpen: false, key: 0, name: '', mediaId: 0 })}
            />
          </div>
        }
      >
