...
import ShareItem from '~/components/contents/pressMedia/SearchManagement/Media/Content/ShareItem'
...
const ContentItem = (props: mediaContentListProps) => {
  ...
  return (
    ...
    >
      <a
        href={`/media/saved-search?media_contact_id=${props.contact_id}`}
        ...
        >
          <ul className="list-type4-item__list">
            <li
              ...
              onClick={e => {
                router.push(`/media/saved-search?media_contact_id=${props.contact_id}`)
                e.preventDefault()
              }}
            >
