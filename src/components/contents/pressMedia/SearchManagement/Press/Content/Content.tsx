...
import ContentItem from '~/components/contents/pressMedia/SearchManagement/Press/Content/ContentItem'
                    ...
                    <ul className="list-type4__group">
                      {pressContentList && pressContentList.length > 0 ? (
                        pressContentList.map((e, index) => (
                          <ContentItem
                            {...e}
                            key={'list-type4-item__section' + 'ContentPress_searchContentList' + e.contact_id}
                          />
                        ))
                      ) : (
