...
const PressContentDeletePopup = () => {
  const { contentDeletePopup, setSelectedDeleteContent, selectedDeleteAction } = usePressSavedSearchManagement()
  const [isLoading, setIsLoading] = useState(false)

  const deleteAction = async () => {
    setIsLoading(() => true)
    await selectedDeleteAction(contentDeletePopup)
    setIsLoading(() => false)
  }
  return (
    <>
...
export default PressContentDeletePopup
