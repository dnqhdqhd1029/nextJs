    ...
    <li
      ...
      onClick={e => {
        ...
        if (aTarget.className && typeof aTarget.className === 'string') {
          ...
          if (!isInList) {
            setMediaIdParamsAction(props, mediaListParams, mediaDto)
            e.preventDefault()
          }
        } else {
          setMediaIdParamsAction(props, mediaListParams, mediaDto)
          ...
          <li className="list-type2-item__contents">
            <div className="list-type2-item__header">
              <div className="list-type2-item__thumb">
                {!loading ? (
                  <div className="list-type3__img type-corp">
                    {imageSrc === '' ? (
                      <>
                        {!props.isSysInfo ? (
                          <Tooltips
              ...
              <div className="list-type2-item__info">
                ...
                {props.isSysInfo ? (
                  <Fragment>
                    ...
                    {/* <p className="list-type2-item-header__text">{props?.coverage?.field?.join(', ')}</p> */}
                    <p className="list-type2-item-header__text">
