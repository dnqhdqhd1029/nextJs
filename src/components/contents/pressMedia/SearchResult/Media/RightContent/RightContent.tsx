...
import Activity from '~/components/contents/pressMedia/SearchResult/Media/RightContent/Activity'
import News from '~/components/contents/pressMedia/SearchResult/Media/RightContent/News'
import Profile from '~/components/contents/pressMedia/SearchResult/Media/RightContent/Profile'
                ...
                {!loading ? (
                  <div className="profile__img">
                    {imageSrc === '' ? (
                      ...
                      <img
                        src={imageSrc}
                        id={'mediaIdKeyParam_imageSrc_isSysInfo_' + mediaIdKey}
                        onLoad={e => {
                          //@ts-ignore
                          if (
                            //@ts-ignore
                            ...
                            //@ts-ignore
                            document?.getElementById(`mediaIdKeyParam_imageSrc_isSysInfo_${mediaIdKey}`)?.className =
                              'ratio-vertical'
                          }
                        }}
