...
import MediaSearchFilterItemSub from '~/components/contents/pressMedia/SearchResult/Media/LeftContent/MediaSearchFilterItemSub'
        ...
        >
          ...
          {props.item && props.item.subMenus && props.item.subMenus?.length > 0 ? (
            <span className="lnb-filter__menu-txt type-submenu">
              {'(' + getCurrencyFormat(props.item.subMenus?.length) + ')' || '(0)'}
            </span>
          ) : (
