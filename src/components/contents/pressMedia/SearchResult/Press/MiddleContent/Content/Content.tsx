...
import ContentItem from '~/components/contents/pressMedia/SearchResult/Press/MiddleContent/Content/ContentItem'
...
const Content = () => {
  ...
  const searchReset = () => {
    ...
    pressKeywordSearch('', pressDto, pressListParams)
  }
      ...
      {pressParamKeywordButton && (
        ...
        >
          <FormInputSearch
            ...
            onKeyDown={e => e.key === 'Enter' && pressKeywordSearch(pressParamKeyword, pressDto, pressListParams)}
