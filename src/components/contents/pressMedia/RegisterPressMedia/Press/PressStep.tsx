...
import ExcelStep from '~/components/contents/pressMedia/RegisterPressMedia/Press/Excel/Excel'
import EndStep from '~/components/contents/pressMedia/RegisterPressMedia/Press/Personal/Done'
import PersonalStep from '~/components/contents/pressMedia/RegisterPressMedia/Press/Personal/Personal'
...
const PressStep = () => {
  ...
  return (
    <Fragment>
      {categoryData.id === 'press' && categoryData.main === 'next' && (
