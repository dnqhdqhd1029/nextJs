...
import { personalTabs, ProfileTabs } from '~/components/contents/pressMedia/List/Result/defaultData'
import Activity from '~/components/contents/pressMedia/List/Result/RightContent/Press/Activity'
import News from '~/components/contents/pressMedia/List/Result/RightContent/Press/News'
import Profile from '~/components/contents/pressMedia/List/Result/RightContent/Press/Profile'
