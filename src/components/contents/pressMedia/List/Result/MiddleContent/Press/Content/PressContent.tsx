...
import ContentItem from '~/components/contents/pressMedia/List/Result/MiddleContent/Press/Content/ContentItem'
...
const PressContent = () => {
  ...
  const searchReset = () => {
    ...
    pressKeywordSearch('', pressDto, journalArrayId, isOwner, isFilterSubParam)
  }
      ...
      {pressParamKeywordButton && (
        ...
        >
          <FormInputSearch
            ...
            onKeyDown={e =>
              e.key === 'Enter' &&
              pressKeywordSearch(pressParamKeyword, pressDto, journalArrayId, isOwner, isFilterSubParam)
            }
