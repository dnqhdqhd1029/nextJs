...
const PressOwnerChangePopup = () => {
  const { ownerPopup, ownerChangeAction, setOwnerPopupAction } = usePressListManagement()
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setOwnerPopupAction({ isOpen: false, key: 0, name: '', pressId: 0, title: '' })}
        hasCloseButton
        title={'소유자 변경 확인'}
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              size={'m'}
              color={'link-dark'}
              onClick={() => setOwnerPopupAction({ isOpen: false, key: 0, name: '', pressId: 0, title: '' })}
            />
          </div>
        }
      >
