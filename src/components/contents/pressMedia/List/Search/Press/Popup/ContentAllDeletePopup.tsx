...
const PressContentAllDeletePopup = () => {
  const { contentAllDeletePopup, initSelectedAllDeleteContent, selectedAllDeleteAction } = usePressListManagement()
...
export default PressContentAllDeletePopup
