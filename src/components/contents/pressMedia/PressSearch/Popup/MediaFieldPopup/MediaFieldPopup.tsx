...
import FieldItem from '~/components/contents/pressMedia/PressSearch/Popup/MediaFieldPopup/FieldItem'
...
const MediaFieldPopup = () => {
  ...
  const actionButton = async () => {
    setIsLoading(() => true)
    await setMediaFieldKeywordValueAction(mediaFieldPopup.selectedType, pressSearchOption.additionalParam)
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setMediaFieldPopupAction([], false, pressSearchOption.additionalParam)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setMediaFieldPopupAction([], false, pressSearchOption.additionalParam)}
            />
          </div>
        }
      >
