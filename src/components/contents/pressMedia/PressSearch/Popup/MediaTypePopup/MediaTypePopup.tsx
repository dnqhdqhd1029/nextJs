...
import MediaTypeItem from '~/components/contents/pressMedia/PressSearch/Popup/MediaTypePopup/MediaTypeItem'
...
const MediaTypePopup = () => {
  ...
  const actionButton = async () => {
    setIsLoading(() => true)
    await mediaTypePopupAdjust(mediaTypePopup.selectedType, pressSearchOption.keywordParam)
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setMediaTypePopupAction([], false, pressSearchOption.keywordParam)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setMediaTypePopupAction([], false, pressSearchOption.keywordParam)}
            />
          </div>
        }
      >
