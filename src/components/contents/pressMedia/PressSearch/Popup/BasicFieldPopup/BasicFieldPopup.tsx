...
import FieldItem from '~/components/contents/pressMedia/PressSearch/Popup/BasicFieldPopup/FieldItem'
...
const BasicFieldPopup = () => {
  ...
  const actionButton = async () => {
    setIsLoading(() => true)
    await setFieldKeywordValueAction(basicFieldPopup.selectedType, pressSearchOption.keywordParam)
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setBasicFieldPopupAction([], false, pressSearchOption.keywordParam)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setBasicFieldPopupAction([], false, pressSearchOption.keywordParam)}
            />
          </div>
        }
      >
