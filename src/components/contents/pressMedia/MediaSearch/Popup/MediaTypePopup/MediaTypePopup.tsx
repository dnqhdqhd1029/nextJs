...
import MediaTypeItem from '~/components/contents/pressMedia/MediaSearch/Popup/MediaTypePopup/MediaTypeItem'
...
const MediaTypePopup = () => {
  ...
  const actionButton = async () => {
    setIsLoading(() => true)
    await mediaTypePopupAdjust(mediaTypePopup.selectedType, mediaSearchOption.keywordParam)
    setIsLoading(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setMediaTypePopupAction([], false, mediaSearchOption.keywordParam)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setMediaTypePopupAction([], false, mediaSearchOption.keywordParam)}
            />
          </div>
        }
      >
