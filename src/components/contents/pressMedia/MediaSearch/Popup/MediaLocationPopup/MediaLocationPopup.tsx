...
import MediaLocationItem from '~/components/contents/pressMedia/MediaSearch/Popup/MediaLocationPopup/MediaLocationItem'
...
const MediaLocationPopup = () => {
  ...
  const actionButton = async () => {
    setIsLoadindg(() => true)
    await setPressMediaAreaAction(mediaLocationPopup.selectedType, mediaSearchOption.keywordParam)
    setIsLoadindg(() => false)
  }
  ...
  return (
    <>
      <Popup
        ...
        onClose={() => setMediaLocationPopupAction([], false, mediaSearchOption.keywordParam)}
        hasCloseButton
        ...
        buttons={
          <div className="popup-footer__section">
            ...
            <Button
              ...
              disabled={isLoading}
              color={'link-dark'}
              onClick={() => setMediaLocationPopupAction([], false, mediaSearchOption.keywordParam)}
            />
          </div>
        }
      >
