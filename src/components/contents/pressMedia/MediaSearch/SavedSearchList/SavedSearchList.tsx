...
import MediaContent from '~/components/contents/pressMedia/MediaSearch/SavedSearchList/MediaContent'
import PressContent from '~/components/contents/pressMedia/MediaSearch/SavedSearchList/PressContent'
import { useMediaSearchOptions } from '~/utils/hooks/contents/pressMedia/useMediaSearchOptions'

const SavedSearchList = () => {
  const { pressMediaListOption, licenseInfo, setPressMediaListOptionAction } = useMediaSearchOptions()
  return (
