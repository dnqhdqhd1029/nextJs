...
const MediaSearchRegisterItem = (item: mediaContentListProps) => {
  const { searchRegisterListPopup, mediaSearchRegisterListCheckStatusChange } = usePressProfile()
...
export default MediaSearchRegisterItem
