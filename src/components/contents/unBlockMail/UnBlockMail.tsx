...
const UnBlockMail = () => {
  ...
  const { unBlockLoading, isErrPage, unBlockUser, isCompletePage, unblockAction } = useBlockmail()
                ...
                <div className="log-type2__group">
                  <ul className="log-type2__bullet">
                    <li>
                      ...
                      <p className="font-body__regular">이메일 수신 거부를 해제했습니다.</p>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="log-type2__section">
              <div className="log-type2__group">
                <ul className="interval-mt14">
                  <li>
                    <h2 className="font-heading--h5">이메일 수신 거부 해제</h2>
                  </li>
                  <li>
                    <p className="font-body__regular">
                      이메일을 수신거부를 해제 하시겠습니까?
                      <br />
                      수신하려면 예를 선택해 주세요
                    </p>
                  </li>
                ...
                <div className="log-type2__btn">
                  <Button
                    ...
                    size={'m'}
                    color={'primary'}
                    onClick={() => unblockAction(unBlockUser)}
                  />
                  <Button
                    label={'아니오'}
                    cate={'default'}
