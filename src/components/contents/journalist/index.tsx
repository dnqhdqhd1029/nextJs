...
import AwardPopup from '~/components/contents/journalist/popup/AwardPopup'
import ContactPopup from '~/components/contents/journalist/popup/ContactPopup'
import EtcPopup from '~/components/contents/journalist/popup/EtcPopup'
import FieldPopup from '~/components/contents/journalist/popup/FieldPopup'
import ProfilePopup from '~/components/contents/journalist/popup/ProfilePopup'
import SettingPopup from '~/components/contents/journalist/popup/SettingPopup'
import SocialPopup from '~/components/contents/journalist/popup/SocialPopup'
                  ...
                  <div className="reporter-main-profile">
                    ...
                    <div className="reporter-main-profile__detail clearfix">
                      <dl>
                        <dd>
                          <div className="flex-wrap-column">
                            <div className="flex-just-start align-items-start column">
                              <div>담당 분야</div>
                              <div>
                                <div className="label">
                                  <span>경제</span>
...
export default JournalistInfoPage
