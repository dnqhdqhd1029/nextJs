            ...
            <ul className="grid-col2 type-interval20">
              <li>
                <dl className="dl-table-type1__section">
                  ...
                  {/* @ts-ignore */}
                  {getActionData?.category !== 'NEWSWIRE_RELEASE' && getActionData?.mailingCount?.totalCount > 0 && (
                    <Fragment>
                      <dt>
                      ...
                      <dd>
                        <div className="accordion-type3__group">
                          <div className="accordion-type3-button__group">
                            <span className="accordion-type3__label">{getActionData?.mailingCount?.totalCount}명</span>
                            <button
                          ...
                          >
                            <ul className="accordion-type3-panel__list">
                                    ...
                                    {getActionData?.jrnlstListList &&
                                      ...
                                      getActionData?.jrnlstListList.map((e, index) => (
                                        <span key={`jrnlistList-${e.jrnlstListId}`}>
                                          ...
                                          <a
                                            href={`/contacts/list-result?jrnlstList_id=${e.jrnlstListId}`}
                                            className={cn(
                                              `button-${'link-text'}`,
                                              `size-${'m'}`,
                                              `colors-${'body-link'}`
                              ...
                              {getActionData?.mediaListList && getActionData?.mediaListList.length > 0 && (
                                <li>
                                  <div className="font-body__regular">
                                    <span className="mr-4">매체 리스트:</span>
                                    {getActionData?.mediaListList &&
                                      ...
                                      getActionData?.mediaListList.map((e, index) => (
                                        <span key={`jrnlistList-${e.mediaListId}`}>
                                          ...
                                          <a
                                            href={`/media/list-result?mediaList_id=${e.mediaListId}`}
                                            className={cn(
                                              `button-${'link-text'}`,
                                              `size-${'m'}`,
                                              `colors-${'body-link'}`
                      ...
                      <dd>
                        <p className="dl-table-type1__text">
                          <Button
                            ...
                            color={'body-link'}
                            onClick={async () => {
                              if (getActionData?.updater?.userId) {
                                const { status, message } = await apiGetOneUser(getActionData?.updater?.userId)
                                if (status === 'S') {
