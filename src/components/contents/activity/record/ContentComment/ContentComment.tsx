              ...
              <div className="list-type6__section">
                <ul className="list-type6__group">
                  {contentsCommentList.map(e => (
                    <li key={'ActivitySearch_list-type6-item__section' + e.actionCommentId}>
                        ...
                        >
                          ...
                          <div className="buttons__group type-right">
                            <Button
                              ...
                              onClick={() =>
                                e.actionCommentId &&
                                commentEdit(e.actionCommentId, contentsCommentText, getActionDataKey)
                              }
                            />
                            <Button
                              label={'취소'}
              ...
              <div className="d-tabs-comment__write">
                ...
                <div className="buttons__group type-right">
                  <Button
                    ...
                    color={'primary'}
                    onClick={() =>
                      userInfo?.userId && haveComment(getActionDataKey, contentsCommentText, getActionData)
                    }
                  />
                  <Button
                    label={'취소'}
