...
const CommentDeletePopup = () => {
  const { commentPopup, getActionData, getActionDataKey, setCommentPopupAction, commentDelete } = useRecordActivity()
        ...
        buttons={
          <div className="popup-footer__section">
            <Button
              ...
              size={'m'}
              color={'primary'}
              onClick={() => commentDelete(commentPopup.key, getActionDataKey, getActionData)}
            />
            <Button
              label={'취소'}
              cate={'default'}
