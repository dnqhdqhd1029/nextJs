...
const meta: Meta<typeof MbPeopleList> = {
  title: '1.Contents/List/MbPeopleList<Type2,3>',
  component: MbPeopleList,
  tags: ['autodocs'],
  args: {},
}

type Story = StoryObj<typeof MbPeopleList>
