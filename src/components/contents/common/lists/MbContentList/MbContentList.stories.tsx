...
import MbContentList from './MbContentList'

import icoSvgData from '~/components/common/ui/icon/icoSvgData.json'

const meta: Meta<typeof MbContentList> = {
  title: '1.Contents/List/MbContentList<Type1>',
  component: MbContentList,
  tags: ['autodocs'],
  args: {},
}

type Story = StoryObj<typeof MbContentList>
